...
func main() {
	...
	mgmtToken := v.GetString("SC_GS1_AUTH0_MGMTTOKEN")

	API_ID := v.GetString("SC_GS1_AUTH0_API_ID")

	domain := v.GetString("SC_GS1_AUTH0_DOMAIN")

	userEmail := v.GetString("SC_GS1_EMAIL_TEST")

	requestId := v.GetString("SC_GS1_REQUESTID_TEST")
