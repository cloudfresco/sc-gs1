...
func TestMain(m *testing.M) {
	...
	logEpcis = config.SetUpLogging(logOpt.EpcisPath)
	...
	go StartEpcisServer(logEpcis, true, pwd, dbOpt, redisOpt, mailerOpt, grpcServerOpt, jwtOpt, oauthOpt, userOpt, uptraceOpt, dbService, redisService, mailerService)
