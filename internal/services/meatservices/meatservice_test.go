...
func TestMain(m *testing.M) {
	...
	logMeat = config.SetUpLogging(logOpt.MeatPath)
	...
	go StartMeatServer(logMeat, true, pwd, dbOpt, redisOpt, mailerOpt, grpcServerOpt, jwtOpt, oauthOpt, userOpt, uptraceOpt, dbService, redisService, mailerService)
