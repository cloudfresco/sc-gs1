...
type LogOptions struct {
	...
	InventoryPath string `mapstructure:"log_inventory_file_path"`
	InvoicePath   string `mapstructure:"log_invoice_file_path"`
	LogisticsPath string `mapstructure:"log_logistics_file_path"`
	MeatPath      string `mapstructure:"log_meat_file_path"`
	EpcisPath     string `mapstructure:"log_epcis_file_path"`
...
type GrpcServerOptions struct {
	...
	GrpcInventoryServerPort string `mapstructure:"grpc_inventory_server_port"`
	...
	GrpcMeatServerPort      string `mapstructure:"grpc_meat_server_port"`
	GrpcEpcisServerPort     string `mapstructure:"grpc_epcis_server_port"`
...
func GetRedisConfig(log *zap.Logger, v *viper.Viper) (*RedisOptions, error) {
	...
	redisOpt.Addr = v.GetString("SC_GS1_REDIS_ADDRESS")
	return &redisOpt, nil
}
...
func GetMailerConfig(log *zap.Logger, v *viper.Viper) (*MailerOptions, error) {
	...
	mailerOpt.Server = v.GetString("SC_GS1_MAILER_SERVER")
	MailerPort, err := strconv.Atoi(v.GetString("SC_GS1_MAILER_PORT"))
	if err != nil {
		log.Error("Error", zap.Error(err))
		return nil, err
	}
	mailerOpt.Port = MailerPort
	mailerOpt.User = v.GetString("SC_GS1_MAILER_USER")
	mailerOpt.Password = v.GetString("SC_GS1_MAILER_PASS")
...
func GetServerConfig(log *zap.Logger, v *viper.Viper) (*ServerOptions, error) {
	...
	serverOpt.BackendServerAddr = v.GetString("SC_GS1_BACKEND_SERVER_ADDRESS")
	serverOpt.ApigServerAddr = v.GetString("SC_GS1_APIG_SERVER_ADDRESS")
	serverOpt.ServerTLS = v.GetString("SC_GS1_SERVER_TLS")
	serverOpt.CaCertPath = v.GetString("SC_GS1_CA_CERT_PATH")
	serverOpt.CertPath = v.GetString("SC_GS1_CERT_PATH")
	serverOpt.KeyPath = v.GetString("SC_GS1_KEY_PATH")
	serverOpt.ClientOriginUrl = v.GetString("SC_GS1_CLIENT_ORIGIN_URL")
	serverOpt.Auth0Audience = v.GetString("SC_GS1_AUTH0_AUDIENCE")
	serverOpt.Auth0Domain = v.GetString("SC_GS1_AUTH0_DOMAIN")
	serverOpt.Auth0ClientId = v.GetString("SC_GS1_AUTH0_CLIENT_ID")
	serverOpt.Auth0Connection = v.GetString("SC_GS1_AUTH0_CONNECTION")
	serverOpt.Auth0MgmtToken = v.GetString("SC_GS1_AUTH0_MGMTTOKEN")
	serverOpt.Auth0ApiId = v.GetString("SC_GS1_AUTH0_API_ID")
...
func GetJWTConfig(log *zap.Logger, v *viper.Viper, isTest bool, jwtKey string, jwtDuration string) (*JWTOptions, error) {
	...
	jwtOpt.AccessSecret = v.GetString("SC_GS1_ACCESS_SECRET")
	jwtOpt.RefreshSecret = v.GetString("SC_GS1_REFRESH_SECRET")
	if err != nil {
		log.Error("Error", zap.Error(err))
		return nil, err
	}
...
func GetUserTestConfig(log *zap.Logger, v *viper.Viper) (*UserTestOptions, error) {
	...
	userTestOpt.Email = v.GetString("SC_GS1_EMAIL_TEST")
	userTestOpt.Tokenstring = v.GetString("SC_GS1_TOKENSTRING_TEST")
...
func GetLogConfig(v *viper.Viper) (*LogOptions, error) {
	logOpt := LogOptions{}
	logOpt.Path = v.GetString("SC_GS1_LOG_FILE_PATH")
	logOpt.UserPath = v.GetString("SC_GS1_USER_LOG_FILE_PATH")
	logOpt.PartyPath = v.GetString("SC_GS1_PARTY_LOG_FILE_PATH")
	logOpt.OrderPath = v.GetString("SC_GS1_ORDER_LOG_FILE_PATH")
	logOpt.InventoryPath = v.GetString("SC_GS1_INVENTORY_LOG_FILE_PATH")
	logOpt.InvoicePath = v.GetString("SC_GS1_INVOICE_LOG_FILE_PATH")
	logOpt.LogisticsPath = v.GetString("SC_GS1_LOGISTICS_LOG_FILE_PATH")
	logOpt.MeatPath = v.GetString("SC_GS1_MEAT_LOG_FILE_PATH")
	logOpt.EpcisPath = v.GetString("SC_GS1_EPCIS_LOG_FILE_PATH")
	logOpt.SearchPath = v.GetString("SC_GS1_SEARCH_LOG_FILE_PATH")
	logOpt.Level = v.GetString("SC_GS1_LOG_LEVEL")
	return &logOpt, nil
}
...
func GetUptraceConfig(log *zap.Logger, v *viper.Viper) (*UptraceOptions, error) {
	...
	uptraceOpt.Dsn = v.GetString("SC_GS1_UPTRACE_DSN")
...
func GetViper() (*viper.Viper, error) {
	...
	configFilePath := v.GetString("SC_GS1_CONFIG_FILE_PATH")
...
func GetGrpcServerConfig(log *zap.Logger, v *viper.Viper) (*GrpcServerOptions, error) {
	...
	grpcServerOpt.GrpcUserServerPort = v.GetString("SC_GS1_GRPC_USER_SERVER_PORT")
	grpcServerOpt.GrpcPartyServerPort = v.GetString("SC_GS1_GRPC_PARTY_SERVER_PORT")
	grpcServerOpt.GrpcOrderServerPort = v.GetString("SC_GS1_GRPC_ORDER_SERVER_PORT")
	grpcServerOpt.GrpcInventoryServerPort = v.GetString("SC_GS1_GRPC_INVENTORY_SERVER_PORT")
	grpcServerOpt.GrpcInvoiceServerPort = v.GetString("SC_GS1_GRPC_INVOICE_SERVER_PORT")
	grpcServerOpt.GrpcLogisticsServerPort = v.GetString("SC_GS1_GRPC_LOGISTICS_SERVER_PORT")
	grpcServerOpt.GrpcMeatServerPort = v.GetString("SC_GS1_GRPC_MEAT_SERVER_PORT")
	grpcServerOpt.GrpcEpcisServerPort = v.GetString("SC_GS1_GRPC_EPCIS_SERVER_PORT")
	grpcServerOpt.GrpcSearchServerPort = v.GetString("SC_GS1_GRPC_SEARCH_SERVER_PORT")
	grpcServerOpt.GrpcCaCertPath = v.GetString("SC_GS1_GRPC_CA_CERT_PATH")
	grpcServerOpt.GrpcCertPath = v.GetString("SC_GS1_GRPC_CERT_PATH")
	grpcServerOpt.GrpcKeyPath = v.GetString("SC_GS1_GRPC_KEY_PATH")
