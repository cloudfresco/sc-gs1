...
import (
	...
	"github.com/cloudfresco/sc-gs1/internal/services/inventoryservices"
...
func main() {
	...
	log := config.SetUpLogging(logOpt.InventoryPath)
	...
	pwd, _ := os.Getwd()
	inventoryservices.StartInventoryServer(log, false, pwd, dbOpt, redisOpt, mailerOpt, grpcServerOpt, jwtOpt, oauthOpt, userOpt, uptraceOpt, dbService, redisService, mailerService)
}
