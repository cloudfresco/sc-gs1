...
import (
	...
	"github.com/cloudfresco/sc-gs1/internal/services/meatservices"
...
func main() {
	...
	log := config.SetUpLogging(logOpt.MeatPath)
	...
	pwd, _ := os.Getwd()
	meatservices.StartMeatServer(log, false, pwd, dbOpt, redisOpt, mailerOpt, grpcServerOpt, jwtOpt, oauthOpt, userOpt, uptraceOpt, dbService, redisService, mailerService)
}
